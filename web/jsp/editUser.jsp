...
<table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center">
      ...
      <table width="801" height="436" border="0" cellpadding="0" cellspacing="0" style="margin-top: 8px"    class="bg">
        <tr>
          <td valign="top">
          ...
          <td height="243" valign="top">
            <form name="form" method="post" action="/userBaseServlet.do?action=1&userId=<%=user.getUserId()%>" onSubmit="return checkAction()">
              <table width="575" height="25" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <table width="350" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
                    <tr>
                      <th width="35%" height="30"><span class="word_white">姓&nbsp;&nbsp;名：</span></th>
                      <td width="65%" bgcolor="#FFFFFF"><input id="userName" name="userName" type="text" size="27" value="<%=user.getUserName()%>" readonly="true"></td>
                    </tr>
                    <tr>
